  ...
  <div className="body-inner">
    ...
    {/*  <FlatButton href="mainLogin"><i className="nav-icon material-icons">keyboard_arrow_left</i></FlatButton>
      <center><h2 className="article-title">Terms and Conditions</h2>  </center>*/}
        ...
        <p>Last updated: March 10, 2017</p>
       ...
       <h5>PURCHASES</h5>
        ...
        <p>We therefore reserve the right to change or update information and to correct erors, inaccuracies, or omissions at any time without prior notice.</p>
        ...
        <p>The Service and its original content, features and functionality are and will remain the exclusive property of HOWL Alert and its licensors. The Service is protected by copyright, trademark, and other  laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of HOWL Alert.</p>


        <h5>LINKS TO OTHER WEB SITES</h5>
         <p>Our Service may contain links to third party web sites or services that are not owned or controlled by HOWL Alert.</p>
