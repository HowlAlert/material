    ...
    <div className="">
      ...
      <div className="">
              ...
              </div>
       {
        ...
        ?
        <div>
          <a className="flLeft MiddleAlertImages" href="#/app/Monitoring">
             <img src="assets/images/fire-button-unsubscribed.png" width="120 "/>
          </a>

          <a className="flLeft AmbulanceAlertImage" href="#/app/Monitoring">
              <img src="assets/images/ambulance-button-unsubscribed.png"  width="120"/>
          </a>

        <div>
         <a className="flLeft PoliceAlertImage" href="#/app/Monitoring">
